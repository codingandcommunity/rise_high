...
class Food(object):
    ...
    def place_random(self):
        ...
        self.turt.color(color_list[self.turt.c_index])
        self.turt.c_index += 1
        if self.turt.c_index == len(color_list):
            self.turt.c_index = 0
...
class Scoreboard(object):
    ...
    def __init__(self, game, font="Arial", fntsize=18, fntstyle="normal"):
        # Connect with game object
        self.game = game
        self.font = font
    ...
    def write_score(self, scr, scr_2, highscr):
        ''' Write score on screen. Called every game tick. '''
        self.pen.clear() # Remove previous score
        self.pen.write("Player 1: {}   Player 2: {}    High Score: {}".format(scr, scr_2, highscr), 
                       align="center", 
